    ...
    <div className={cx("container-infor")}>
        ...
        <Col xs={12} sm={6} md={6} lg={4}>
          <div className={cx("container-infor-item")}>
            ...
            <div>
              <input type="text" className={cx("infor-input")} />
              <span>
                (Đơn hàng phải lớn hơn hoặc bằng 100.000đ mới có thể sử dụng
        ...
        <Col xs={12} sm={6} md={6} lg={4}>
          <div className={cx("container-infor-item")}>
            ...
            <div>
              <input type="text" className={cx("infor-input")} />
              <span>
                (VD 7200 tức hóa đơn nạp tiền sẽ tồn tại trong 2 tiếng)
              </span>
            </div>
          </div>
        </Col>
        ...
        <Col xs={12} sm={6} md={6} lg={4}>
          <div className={cx("container-infor-item")}>
            ...
            <div>
              <input type="text" className={cx("infor-input")} />
              <span>
                Đơn hàng có giá trị lớn hơn hoặc bằng 50.000đ sẽ nhận được 1
                lượt quay (SPIN).
              </span>
            </div>
          </div>
        ...
        <Col xs={12} sm={6} md={6} lg={4}>
          ...
          <div className={cx("container-infor-item")}>
            ...
            <div>
              ...
              <span>
                Nếu chọn ON, các thành viên khi đăng ký sẽ phải cần BQT duyệt
                mới có thể sử dụng.
              </span>
            </div>
          </div>
        ...
        <Col xs={12} sm={6} md={6} lg={4}>
          ...
          <div className={cx("container-infor-item")}>
            ...
            <div>
              <input type="text" className={cx("infor-input")} />
              <span>
                Ví dụ nhập 2592000: tức hệ thống sẽ tự động xoá các tài khoản
                DIE nằm trên hệ thống 4 tuần, để 0 để tắt chức năng này
              </span>
            </div>
          </div>
        </Col>
      ...
      <Row className={cx("container-infor-wrap")}>
        ...
        <Col xs={12} sm={6} md={6} lg={4}>
          <div className={cx("container-infor-item")}>
            <div className={cx("infor-name")}>
              ON/OFF Change password định kỳ
            </div>
